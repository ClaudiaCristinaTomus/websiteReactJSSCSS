  ...
  return (
    <div className={styles.footer}>
      ...
      <div className={styles.column2}>
        <a className={styles.footer_item} href={"/"}>About Us</a>
        <a className={styles.footer_item} href={"/"}>Contact</a>
        <a className={styles.footer_item} href={"/"}>Blog</a>
      </div>
      <div className={styles.column3}>
        <a className={styles.footer_item} href={"/"}>Careers</a>
        <a className={styles.footer_item} href={"/"}>Support</a>
        <a className={styles.footer_item} href={"/"}>Privacy Policy</a>
      </div>
